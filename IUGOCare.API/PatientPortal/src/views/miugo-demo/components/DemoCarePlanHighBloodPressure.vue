...
export default Vue.extend({
  name: 'DemoCarePlanHighBloodPressure',
  components: {},
  methods: {
      ...
      sections: [
        {
          ...
          items: [
            {
              body:
                'Lower blood pressure over the next 6 months.',
            },
          ],
        },
        {
          ...
          items: [
            {
              body: 'Self-management of hypertension with RPM.',
            },
            {
              body: 'A better understanding of medication use and hypertension.',
            },
          ],
        },
        {
          ...
          items: [
            {
              body:
                'RPM for hypertension using a connected blood pressure device.',
              icon: 'books',
              to: '/miugo/education',
              tooltip: 'Education',
            },
