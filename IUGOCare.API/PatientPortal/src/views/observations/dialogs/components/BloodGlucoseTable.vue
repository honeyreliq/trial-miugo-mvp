      ...
      <v-simple-table class="mb-4">
        <tbody>
          ...
          <tr class="text-center white">
            <td class="align-center text-no-wrap border-bottom border-right">{{ $t('fasting') }}</td>
            <td class="border-bottom border-right">
              <span class="align-center text-no-wrap">
                {{ fasting.criticalLow }} {{ fasting.unitOfMeasure }}
              </span>
            </td>
            <td class="border-bottom border-right">
              <span class="align-center text-no-wrap">
                {{ fasting.atRiskLow }} {{ fasting.unitOfMeasure }}
              </span>
            </td>
            <td class="border-bottom border-right">
              <span class="align-center text-no-wrap">
                {{ fasting.atRiskHigh }} {{ fasting.unitOfMeasure }}
              </span>
            </td>
            <td class="border-bottom">
              <span class="align-center text-no-wrap">
                {{ fasting.criticalHigh }} {{ fasting.unitOfMeasure }}
              </span>
            </td>
          </tr>
          <tr class="text-center white">
            <td class="align-center text-no-wrap border-right">{{ $t('nonFasting') }}</td>
            <td class="border-right">
              <span class="align-center text-no-wrap">
                {{ nonFasting.criticalLow }} {{ nonFasting.unitOfMeasure }}
              </span>
            </td>
            <td class="border-right">
              <span class="align-center text-no-wrap">
                {{ nonFasting.atRiskLow }} {{ nonFasting.unitOfMeasure }}
              </span>
            </td>
            <td class="border-right">
              <span class="align-center text-no-wrap">
                {{ nonFasting.atRiskHigh }} {{ nonFasting.unitOfMeasure }}
              </span>
            </td>
            <td>
              <span class="align-center text-no-wrap">
                {{ nonFasting.criticalHigh }} {{ nonFasting.unitOfMeasure }}
              </span>
            </td>
          </tr>
        </tbody>
...
export default Vue.extend({
    ...
    monitoringParameters: {
      ...
      default(): Array<MonitoringParameter> {
        const defaultParameters = [
          {
            observationDataType: ObservationDataTypes.BLOOD_GLUCOSE_FASTING,
            criticalLow: 'N/A',
            atRiskLow: 'N/A',
            atRiskHigh: 'N/A',
            criticalHigh: 'N/A',
          ...
          {
            observationDataType: ObservationDataTypes.BLOOD_GLUCOSE_NON_FASTING,
            criticalLow: 'N/A',
            atRiskLow: 'N/A',
            atRiskHigh: 'N/A',
            criticalHigh: 'N/A',
  ...
  computed: {
    fasting(): MonitoringParameter {
      return this.monitoringParameters.find(
              (mp: MonitoringParameter) =>
                mp.observationDataType ===
                ObservationDataTypes.BLOOD_GLUCOSE_FASTING
            );
    },
    nonFasting(): MonitoringParameter {
      return this.monitoringParameters.find(
        (mp: MonitoringParameter) =>
          mp.observationDataType ===
          ObservationDataTypes.BLOOD_GLUCOSE_NON_FASTING
      );
    },
  },
});
