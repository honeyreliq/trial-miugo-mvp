...
namespace IUGOCare.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20200721165338_UpdateTestClinicData")]
    partial class UpdateTestClinicData
    {
            ...
            modelBuilder.Entity("IUGOCare.Domain.Entities.PatientTour", b =>
                {
                    b.Property<DateTimeOffset>("Completed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetimeoffset")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 7, 21, 13, 55, 25, 247, DateTimeKind.Unspecified).AddTicks(9202), new TimeSpan(0, 0, 0, 0, 0)));
