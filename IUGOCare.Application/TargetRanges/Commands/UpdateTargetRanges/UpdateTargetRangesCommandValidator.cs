...
{
    public class UpdateTargetRangesCommandValidator : AbstractValidator<UpdateTargetRangesCommand>
    {
        public UpdateTargetRangesCommandValidator()
        {
            ...
            RuleForEach(p => p.TargetRanges).SetValidator(new ExistingTargetRangeValidator());
        }
    }

    public class ExistingTargetRangeValidator : AbstractValidator<TargetRange>
    {
        public ExistingTargetRangeValidator()
        {
